    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) =
            uniffiRustCall { status ->
                ...
                UniffiLib.INSTANCE.ffi_cooklang_bindings_rustbuffer_alloc(size.toLong(), status)
            }.also {
                if (it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) =
            uniffiRustCall { status ->
                UniffiLib.INSTANCE.ffi_cooklang_bindings_rustbuffer_free(buf, status)
            }
    }
...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            loadIndirect<UniffiLib>(componentName = "cooklang_bindings")
                .also { lib: UniffiLib ->
    ...
    fun uniffi_cooklang_bindings_fn_clone_aisleconf(
        `ptr`: Pointer,
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_u8(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_u8(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_i8(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_i8(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_u16(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_u16(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_i16(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_i16(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_u32(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_u32(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_i32(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_i32(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_u64(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_u64(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_i64(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_i64(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_f32(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_f32(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_f64(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_f64(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_pointer(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_pointer(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_rust_buffer(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_rust_buffer(`handle`: Long): Unit
    ...
    fun ffi_cooklang_bindings_rust_future_cancel_void(`handle`: Long): Unit

    fun ffi_cooklang_bindings_rust_future_free_void(`handle`: Long): Unit
...
open class AisleConf : Disposable, AutoCloseable, AisleConfInterface {
    ...
    private class UniffiCleanAction(private val pointer: Pointer?) : Runnable {
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_cooklang_bindings_fn_free_aisleconf(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall { status ->
            UniffiLib.INSTANCE.uniffi_cooklang_bindings_fn_clone_aisleconf(pointer!!, status)
        }
    }
        ...
        return FfiConverterOptionalString.lift(
            callWithPointer {
                uniffiRustCall { _status ->
                    UniffiLib.INSTANCE.uniffi_cooklang_bindings_fn_method_aisleconf_category_for(
                        it,
...
public object FfiConverterTypeAisleConf : FfiConverter<AisleConf, Pointer> {
    ...
    override fun allocationSize(value: AisleConf) = 8UL
...
public object FfiConverterTypeQuantityType : FfiConverterRustBuffer<QuantityType> {
    ...
    override fun allocationSize(value: QuantityType) = 4UL
...
public object FfiConverterTypeValue : FfiConverterRustBuffer<Value> {
    ...
    override fun allocationSize(value: Value) =
        when (value) {
            is Value.Number -> {
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                (
...
public object FfiConverterSequenceTypeAisleIngredient : FfiConverterRustBuffer<List<AisleIngredient>> {
    ...
    override fun allocationSize(value: List<AisleIngredient>): ULong {
        val sizeForLength = 4UL
...
public object FfiConverterMapStringMapTypeGroupedQuantityKeyTypeValue : FfiConverterRustBuffer<Map<kotlin.String, Map<GroupedQuantityKey, Value>>> {
    override fun read(buf: ByteBuffer): Map<kotlin.String, Map<GroupedQuantityKey, Value>> {
        val len = buf.getInt()
        return buildMap<kotlin.String, Map<GroupedQuantityKey, Value>>(len) {
            repeat(len) {
                val k = FfiConverterString.read(buf)
    ...
    override fun allocationSize(value: Map<kotlin.String, Map<GroupedQuantityKey, Value>>): ULong {
        val spaceForMapSize = 4UL
        val spaceForChildren =
            value.map { (k, v) ->
                FfiConverterString.allocationSize(k) +
    ...
    override fun write(
        value: Map<kotlin.String, Map<GroupedQuantityKey, Value>>,
        buf: ByteBuffer,
    ) {
        buf.putInt(value.size)
        // The parens on `(k, v)` here ensure we're calling the right method,
...
public object FfiConverterMapTypeGroupedQuantityKeyTypeValue : FfiConverterRustBuffer<Map<GroupedQuantityKey, Value>> {
    ...
    override fun allocationSize(value: Map<GroupedQuantityKey, Value>): ULong {
        val spaceForMapSize = 4UL
        val spaceForChildren =
            value.map { (k, v) ->
    ...
    override fun write(
        value: Map<GroupedQuantityKey, Value>,
        buf: ByteBuffer,
    ) {
        buf.putInt(value.size)
        // The parens on `(k, v)` here ensure we're calling the right method,
